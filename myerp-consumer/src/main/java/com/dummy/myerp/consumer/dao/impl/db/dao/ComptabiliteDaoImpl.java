...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
	...
	/** SQLgetSequenceEcriture */
	private static String SQLgetSequenceEcriture;

	public static String getSQLgetSequenceEcriture() {
		return SQLgetSequenceEcriture;
	}

	public static void setSQLgetSequenceEcriture(String sQLgetSequenceEcriture) {
		SQLgetSequenceEcriture = sQLgetSequenceEcriture;
	}

	@Override
	public SequenceEcritureComptable getSequenceEcriture(String codeJournal, Integer annee) throws NotFoundException {
		NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
		MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
		...
		try {
			vBean = vJdbcTemplate.queryForObject(SQLgetSequenceEcriture, vSqlParams, vRM);
		} catch (Exception e) {
	...
	@Override
	public void updateSequenceEcritureComptable(String codeJournal, SequenceEcritureComptable sequenceJournal) {
		NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
		MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
		vSqlParams.addValue("journal_code", codeJournal);
		vSqlParams.addValue("annee", sequenceJournal.getAnnee());
		vSqlParams.addValue("derniere_valeur", sequenceJournal.getDerniereValeur());
	...
	@Override
	public void insertSequenceEcritureComptable(String codeJournal, SequenceEcritureComptable sequenceJournal) {
		NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
		MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
		vSqlParams.addValue("journal_code", codeJournal);
		vSqlParams.addValue("annee", sequenceJournal.getAnnee());
